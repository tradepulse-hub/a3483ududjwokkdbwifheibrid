...
export function ClaimCoin({ userAddress }: { userAddress: string }) {
  ...
  return (
    <div
      className={`bg-gradient-to-b from-gray-900/90 to-gray-950/90 backdrop-blur-sm rounded-${deviceInfo.isMobile ? "lg" : "2xl"} p-${deviceInfo.isMobile ? "4" : "5"} max-w-md mx-auto shadow-xl border border-gray-800`}
    >
