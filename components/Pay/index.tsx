    ...
    <div className="flex flex-col items-center gap-4 p-6 border rounded-lg shadow-sm">
      ...
      <div className="w-full space-y-4">
        <div>
          ...
          <Input value={recipientAddress} onChange={(e) => setRecipientAddress(e.target.value)} placeholder="0x..." />
        </div>
      ...
      <Button onClick={() => handlePay(recipientAddress, selectedToken, amount, setStatus)} className="w-full mt-2">
        Buy Coffee
      </Button>
      {status && (
